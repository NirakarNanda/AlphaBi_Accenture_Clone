...
const navLinks: NavLinkItem[] = [
  {
    title: "Insights",
    path: "/insights",
    dropdown: ["Marketing", "Mergers & Acquisitions (M&A)", "Metaverse", "Operating Models"],
  },
  {
    title: "Services",
    path: "/services",
    dropdown: ["Business Strategy", "Change Management", "Cloud", "Customer Experience"],
  },
  {
    title: "Industries",
    path: "/industries",
    dropdown: ["Data & Analytics", "Digital Commerce", "Digital Engineering & Manufacturing", "Marketing"],
  },
  {
    title: "Career",
    path: "/career",
    dropdown: ["Finance Consulting", "Infrastructure", "Marketing", "Mergers & Acquisitions (M&A)"],
  },
  {
    title: "About",
    path: "/about",
    ...
    <nav className="fixed mx-auto border border-[#33353F] top-0 left-0 right-0 z-10 bg-[#121212] bg-opacity-100">
      <div className="flex container lg:py-4 items-center justify-between mx-auto px-4 py-2">
        ...
        <div className="flex items-center">
          <input type="text" placeholder="Search..." className="px-2 py-1 border border-gray-300 rounded mr-4" />
